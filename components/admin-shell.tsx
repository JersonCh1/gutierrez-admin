...
const SECTIONS: SectionDef[] = [
  ...
  { key: "equipo",        label: "Equipo",            href: "/equipo",        roles: ["SUPERADMIN"] },
  { key: "configuracion", label: "Configuración",     href: "/configuracion", roles: ["SUPERADMIN"] },
]
      ...
      <aside className="w-[260px] shrink-0 border-r border-[var(--color-border-2)] flex flex-col px-7 py-9">
        ...
        <div className="mt-auto pt-6 border-t border-[var(--color-border-2)] flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-silver text-[11px] truncate">{user.email}</p>
          </div>
